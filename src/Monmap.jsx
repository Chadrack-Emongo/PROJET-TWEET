...
export default function Monmap() {
    ...
    return (
        <div>
            <div className='flex justify-between p-10 border-slate-700 border' >
                <h3 className='font-extrabold text-2xl'>Home</h3>
                <Icones classIcone="text-2xl" icones="src/assets/images/Timeline-Prop.svg" />
                <Icones className=''>
            ...
            {
                posts.map((tab) => (<Montweet unTweet={tab} />))
            }
